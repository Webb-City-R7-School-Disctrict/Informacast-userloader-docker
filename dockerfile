...
RUN echo "0 * * * * cd /home/loaderuser/Informacast-userloader-docker && /home/loaderuser/Informacast-userloader-docker/loader.sh --do-upload >> /proc/1/fd/1" > /etc/cron.d/loader-cron
